...
void TypedMarshal::PushByType(lua_State* L, void* ptr, const Il2CppType* type)
{
    if (type->byref)
    {
...
restart:
    ...
    case IL2CPP_TYPE_OBJECT:
        ObjectMarshal::Push(L, *(Il2CppObject**)ptr, il2cpp_defaults.object_class);
        break;
    case IL2CPP_TYPE_CLASS:
    case IL2CPP_TYPE_ARRAY:
    case IL2CPP_TYPE_SZARRAY:
    {
        Il2CppClass* viewKlass = il2cpp::vm::Class::FromIl2CppType(type);
        ObjectMarshal::Push(L, *(Il2CppObject**)ptr, viewKlass);
        break;
    }
    ...
    case IL2CPP_TYPE_GENERICINST:
    {
        ...
        {
            ObjectMarshal::Push(L, *(Il2CppObject**)ptr, klass);
        }
        break;
    }
...
void TypedMarshal::PopByType(lua_State* L, int idx, void* ptr, const Il2CppType* type)
{
    if (type->byref)
    {
