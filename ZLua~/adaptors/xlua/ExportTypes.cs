...
// Copy this file into your xLua project's Editor folder, then use menu ZLua/ExportTypes.
// Spec: docs/spec/12-MIGRATION-ADAPTORS.md
//
// Collects types from xLua Generator.LuaCallCSharp (same whitelist as Generate Code).
...
public static class ZLuaXLuaExportTypes
{
    ...
    public static void ExportTypes()
    {
        ...
        WriteLuaModule(absPath, "xLua", byAssembly);
    ...
    static void WriteLuaModule(string absPath, string scheme, SortedDictionary<string, SortedSet<string>> byAssembly)
    {
        ...
        sb.AppendLine("-- Do not edit by hand; regenerate after changing xLua LuaCallCSharp whitelist.");
