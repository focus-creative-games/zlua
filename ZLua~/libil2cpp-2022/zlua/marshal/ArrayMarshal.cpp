...
Il2CppArray* ArrayMarshal::PopFromBytes(lua_State* L, int arrayIndex, Il2CppClass* klass)
{
    ...
    memcpy(il2cpp_array_addr(newArr, uint8_t, 0), data, length);
    return newArr;
}
...
Il2CppArray* ArrayMarshal::PopFromTable(lua_State* L, int arrayIndex, Il2CppClass* klass)
{
    ...
    int32_t length;
    if (!ArrayMarshal::TryGetConsecutiveTableLength(L, arrayIndex, length))
    {
    ...
    case IL2CPP_TYPE_BOOLEAN:
    {
        return PopFromPrimitiveTable<bool>(L, arrayIndex, klass, length);
    }
    case IL2CPP_TYPE_CHAR:
    {
        return PopFromPrimitiveTable<uint16_t>(L, arrayIndex, klass, length);
    }
    case IL2CPP_TYPE_I1:
    {
        return PopFromPrimitiveTable<int8_t>(L, arrayIndex, klass, length);
    }
    case IL2CPP_TYPE_U1:
    {
        return PopFromPrimitiveTable<uint8_t>(L, arrayIndex, klass, length);
    }
    case IL2CPP_TYPE_I2:
    {
        return PopFromPrimitiveTable<int16_t>(L, arrayIndex, klass, length);
    }
    case IL2CPP_TYPE_U2:
    {
        return PopFromPrimitiveTable<uint16_t>(L, arrayIndex, klass, length);
    ...
    case IL2CPP_TYPE_I4:
    {
        return PopFromPrimitiveTable<int32_t>(L, arrayIndex, klass, length);
    }
    case IL2CPP_TYPE_U4:
    {
        return PopFromPrimitiveTable<uint32_t>(L, arrayIndex, klass, length);
    }
    case IL2CPP_TYPE_I8:
    {
        return PopFromPrimitiveTable<int64_t>(L, arrayIndex, klass, length);
    }
    case IL2CPP_TYPE_U8:
    {
        return PopFromPrimitiveTable<uint64_t>(L, arrayIndex, klass, length);
    }
    case IL2CPP_TYPE_R4:
    {
        return PopFromPrimitiveTable<float>(L, arrayIndex, klass, length);
    }
    case IL2CPP_TYPE_R8:
    {
        return PopFromPrimitiveTable<double>(L, arrayIndex, klass, length);
    }
    case IL2CPP_TYPE_STRING:
    {
        return PopFromPrimitiveTable<Il2CppString*>(L, arrayIndex, klass, length);
    }
    default:
    {
        Il2CppArray* newArray = (Il2CppArray*)il2cpp::vm::Array::NewSpecific(klass, (il2cpp_array_size_t)length);
        int elementSize = il2cpp_array_element_size(klass);
        for (int32_t i = 0; i < length; ++i)
        {
            lua_rawgeti(L, arrayIndex, i + 1);
