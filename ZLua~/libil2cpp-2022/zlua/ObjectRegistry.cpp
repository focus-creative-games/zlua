...
namespace zlua
{
    ...
    void ObjectRegistry::EnsureObjectCache(lua_State* L)
    {
    ...
    static bool TryPushCachedObject(lua_State* L, Il2CppObject* obj)
    {
        ...
        ZLuaUserData* ud = (ZLuaUserData*)lua_touserdata(L, -1);
    ...
    void ObjectRegistry::PushObject(lua_State* L, Il2CppObject* obj)
    {
        ...
        ZLuaUserData* ud = (ZLuaUserData*)lua_newuserdatauv(L, sizeof(ZLuaUserData), 0);
        ud->obj = obj;
    ...
    {
        ZLuaUserData* ud = (ZLuaUserData*)lua_touserdata(L, idx);
