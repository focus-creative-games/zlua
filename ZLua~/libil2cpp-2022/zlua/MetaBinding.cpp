...
namespace zlua
{
    ...
    static int InvokeStaticMethod(lua_State* L)
    {
        ...
        return luaL_error(L, "zlua: unsupported static method signature: %s", method->name);
    }
    ...
    static int InvokeInstanceMethod(lua_State* L)
    {
        ...
        return luaL_error(L, "zlua: unsupported instance method signature: %s", method->name);
    }
