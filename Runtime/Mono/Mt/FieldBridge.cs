...
namespace ZLua.Mt
{
    internal static class FieldBridge
    {
        ...
        private static int InvokeInstanceFieldGetterFallback(IntPtr luaState)
        {
            ...
            try
            {
                FieldBridgeFallback.PushInstanceField(luaState, field);
                return 1;
            }
            catch (Exception ex)
            {
        ...
        private static int InvokeStaticFieldGetterFallback(IntPtr luaState)
        {
            ...
            try
            {
                FieldBridgeFallback.PushStaticField(luaState, field);
                return 1;
            }
            catch (Exception ex)
            {
        ...
        private static int InvokeInstanceFieldSetterFallback(IntPtr luaState)
        {
            ...
            return FieldBridgeFallback.AssignInstanceField(luaState, field);
        }
        ...
        private static int InvokeStaticFieldSetterFallback(IntPtr luaState)
        {
            ...
            return FieldBridgeFallback.AssignStaticField(luaState, field);
        }
        ...
        private static void RegisterField(FieldInfo field, int typeId, bool isStatic)
        {
            ...
            if (isStatic)
            {
                ...
                if (FieldBridgeFactory.TryCreateGetter(field, isStatic: true, out LuaCSFunction getter))
                {
                    StaticFieldGetters[fieldId] = getter;
                    CallbackRefs.Add(getter);
                }

                if (FieldBridgeFactory.TryCreateSetter(field, isStatic: true, out LuaCSFunction setter))
                {
            ...
            else
            {
                ...
                if (FieldBridgeFactory.TryCreateGetter(field, isStatic: false, out LuaCSFunction getter))
                {
                    InstanceFieldGetters[fieldId] = getter;
                    CallbackRefs.Add(getter);
                }

                if (FieldBridgeFactory.TryCreateSetter(field, isStatic: false, out LuaCSFunction setter))
                {
    ...
    /// </summary>
    internal static class FieldBridgeFallback
    {
        internal static void PushStaticField(IntPtr luaState, FieldInfo field)
        {
            object value = field.GetValue(null);
            MethodBridgeCore.PushReturnDefaultPublic(luaState, field.FieldType, value);
        }
        ...
        internal static int AssignStaticField(IntPtr luaState, FieldInfo field)
        {
            ...
            try
            {
                value = MethodBridgeCore.ReadValuePublic(luaState, 3, field.FieldType);
            }
            catch (Exception ex)
            {
                return LuaCallbackBoundary.ToLuaError(luaState, ex);
