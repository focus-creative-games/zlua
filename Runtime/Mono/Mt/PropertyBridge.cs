...
namespace ZLua.Mt
{
    internal static class PropertyBridge
    {
        ...
        internal static void BindGetterTable(IntPtr luaState, int getterTableIndex, int typeId, bool isStatic)
        {
            ...
            foreach (KeyValuePair<PropertyKey, int> entry in idMap)
            {
                ...
                {
                    MethodBridgeCore.PushCompiledBridge(luaState, getter);
                }
                else
                {
        ...
        internal static void BindSetterTable(IntPtr luaState, int setterTableIndex, int typeId, bool isStatic)
        {
            ...
            foreach (KeyValuePair<PropertyKey, int> entry in idMap)
            {
                ...
                {
                    MethodBridgeCore.PushCompiledBridge(luaState, setter);
                }
                else
                {
        ...
        private static int InvokeInstancePropertyGetterFallback(IntPtr luaState)
        {
            ...
            try
            {
                PropertyBridgeFallback.PushInstanceProperty(luaState, property);
                return 1;
            }
            catch (Exception ex)
            {
        ...
        private static int InvokeStaticPropertyGetterFallback(IntPtr luaState)
        {
            ...
            try
            {
                PropertyBridgeFallback.PushStaticProperty(luaState, property);
                return 1;
            }
            catch (Exception ex)
            {
        ...
        private static int InvokeInstancePropertySetterFallback(IntPtr luaState)
        {
            ...
            return PropertyBridgeFallback.AssignInstanceProperty(luaState, property);
        }
        ...
        private static int InvokeStaticPropertySetterFallback(IntPtr luaState)
        {
            ...
            return PropertyBridgeFallback.AssignStaticProperty(luaState, property);
        }
        ...
        private static void RegisterProperty(PropertyInfo property, int typeId, bool isStatic)
        {
            ...
            if (isStatic)
            {
                ...
                if (PropertyBridgeFactory.TryCreateGetter(property, isStatic: true, out LuaCSFunction getter))
                {
                    StaticPropertyGetters[propertyId] = getter;
                    CallbackRefs.Add(getter);
                }

                if (PropertyBridgeFactory.TryCreateSetter(property, isStatic: true, out LuaCSFunction setter))
                {
            ...
            else
            {
                ...
                if (PropertyBridgeFactory.TryCreateGetter(property, isStatic: false, out LuaCSFunction getter))
                {
                    InstancePropertyGetters[propertyId] = getter;
                    CallbackRefs.Add(getter);
                }

                if (PropertyBridgeFactory.TryCreateSetter(property, isStatic: false, out LuaCSFunction setter))
                {
        ...
        internal static int PushPropertyGet(IntPtr luaState, PropertyInfo property, object target)
        {
            ...
            return MethodBridgeCore.PushReturnValue(luaState, property.PropertyType, value);
        }
        ...
        internal static int SetPropertyValue(IntPtr luaState, PropertyInfo property, object target, int valueIndex)
        {
            ...
            try
            {
                value = MethodBridgeCore.ReadArgumentValue(luaState, valueIndex, property.PropertyType);
            }
            catch (Exception ex)
            {
                return LuaCallbackBoundary.ToLuaError(luaState, ex);
    ...
    internal static class PropertyBridgeFallback
    {
        internal static void PushStaticProperty(IntPtr luaState, PropertyInfo property)
        {
            ...
            MethodBridgeCore.PushReturnDefaultPublic(luaState, property.PropertyType, value);
        }
        ...
        internal static int AssignStaticProperty(IntPtr luaState, PropertyInfo property)
        {
            ...
            try
            {
                value = MethodBridgeCore.ReadValuePublic(luaState, 3, property.PropertyType);
            }
            catch (Exception ex)
            {
                return LuaCallbackBoundary.ToLuaError(luaState, ex);
        ...
        {
            if (!StructMarshaling.TryGetBoxedTarget(luaState, 1, out object target))
            {
