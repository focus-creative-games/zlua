...
namespace ZLua.Mt
{
    internal static class TypeRegistry
    {
        ...
        private static readonly LuaCSFunction ArrayElementGetCallback = InstanceTarget.Get;
        private static readonly LuaCSFunction ArrayElementSetCallback = InstanceTarget.Set;
        ...
        internal static void RegisterZLuaApi(LuaEnv luaEnv)
        {
        ...
        internal static void RegisterType(LuaEnv luaEnv, Type type)
        {
            IntPtr luaState = luaEnv.LuaState;
        ...
        internal static void EnsureCSharpRoot(IntPtr luaState)
        {
            ...
            IntPtr fn = global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(CSharpIndexCallback);
        ...
        internal static void GetCSharpRoot(IntPtr luaState)
        {
            LuaDataType csharpType = LuaDll.lua_getglobal(luaState, "CSharp");
            Debug.Assert(csharpType == LuaDataType.Table);
        }

        internal static void PushAssemblyTable(IntPtr luaState, Assembly assembly)
        {
            ...
            IntPtr fn = global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(AssemblyTypeIndexCallback);
        ...
        {
            MetaBinding.EnsureMethodAliasKeysValid(type);
            ...
            if (StructMarshaling.IsStructType(type))
            {
        ...
        private static void PushClassTypeTable(IntPtr luaState, Type type)
        {
            ...
            FieldBridge.RegisterFields(type, typeId);
            PropertyBridge.RegisterProperties(type, typeId);
            ...
            MetaBinding.RegisterConstructors(luaState, staticMetatableIndex, type);
            ...
            // 清理注册过程中的临时栈项，保证栈顶是 type table 本身�?            LuaDll.lua_settop(luaState, typeTableIndex);
        }
        ...
        private static void PushStructTypeTable(IntPtr luaState, Type structType)
        {
            ...
            CreateMemberTablesOnStack(luaState, out int staticMethodTableIndex, out int staticGetterTableIndex, out int staticSetterTableIndex);
            FieldBridge.RegisterFields(structType, typeId);
            PropertyBridge.RegisterProperties(structType, typeId);
            PopulateStaticMemberTables(
                luaState,
                structType,
                typeId,
                ...
                staticGetterTableIndex,
                staticSetterTableIndex);
            MetaBinding.RegisterConstructors(luaState, staticMetatableIndex, structType);

            CallbackRefs.Add(StructDefaultCallback);
            IntPtr defaultFn = global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(StructDefaultCallback);
            LuaDll.lua_pushinteger(luaState, typeId);
        ...
        private static void PushEnumTypeTable(IntPtr luaState, Type enumType)
        {
            ...
            IntPtr callFn = global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(EnumCallCallback);
            LuaDll.lua_pushinteger(luaState, typeId);
        ...
        {
            MetaBinding.RegisterStaticMethods(luaState, methodTableIndex, type);
            FieldBridge.BindGetterTable(luaState, getterTableIndex, typeId, isStatic: true);
            FieldBridge.BindSetterTable(luaState, setterTableIndex, typeId, isStatic: true);
            PropertyBridge.BindGetterTable(luaState, getterTableIndex, typeId, isStatic: true);
            PropertyBridge.BindSetterTable(luaState, setterTableIndex, typeId, isStatic: true);
            EventBridge.RegisterEvents(luaState, methodTableIndex, type, typeId);
        }
        ...
        private static void PopulateInstanceMemberTables(
            ...
            int setterTableIndex)
        {
            MetaBinding.RegisterInstanceMethods(luaState, methodTableIndex, type);
            FieldBridge.BindGetterTable(luaState, getterTableIndex, typeId, isStatic: false);
            FieldBridge.BindSetterTable(luaState, setterTableIndex, typeId, isStatic: false);
            PropertyBridge.BindGetterTable(luaState, getterTableIndex, typeId, isStatic: false);
            PropertyBridge.BindSetterTable(luaState, setterTableIndex, typeId, isStatic: false);
            EventBridge.BindInstanceEventsToMethodTable(luaState, methodTableIndex, typeId);
        }
            ...
            int typeId)
        {
            ...
            IntPtr toStringFn = global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(TypeTableToStringCallback);
        ...
        private static void PushValueTypeInstanceMetatable(IntPtr luaState, Type type, int typeTableIndex, LuaCSFunction toStringCallback)
        {
            ...
            IntPtr gcFn = global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(gcCb);
            ...
            if (toStringCallback != null)
            {
                ...
                IntPtr instanceToStringFn = global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(toStringCallback);
        ...
        private static void RegisterEnumConstants(IntPtr luaState, int methodTableIndex, Type enumType)
        {
            ...
            for (int i = 0; i < fields.Length; i++)
            {
                ...
                StructMarshaling.PushUnderlyingInteger(luaState, underlying, field.GetRawConstantValue());
        ...
        private static int InvokeEnumCall(IntPtr luaState)
        {
            try
            {
                ...
                Type underlying = Enum.GetUnderlyingType(enumType);
                if (!StructMarshaling.TryReadUnderlyingInteger(luaState, 2, underlying, out object rawValue))
                {
                    return LuaDllExtension.error(luaState, $"zlua: {GetLuaTypeFullName(enumType)} expects underlying integer value");
                }
                ...
                return StructMarshaling.PushBoxedInstance(luaState, enumValue, 1);
            }
            catch (Exception ex)
            {
        ...
        internal static int PushConstructorInstance(IntPtr luaState, object instance, Type type)
        {
            ...
            int pushed = StructMarshaling.PushBoxedInstance(luaState, instance, typeTableIndex);
        ...
        private static int InvokeStructDefault(IntPtr luaState)
        {
            ...
            {
                int typeId = (int)LuaDll.lua_tointeger(luaState, LuaConsts.LuaRegistryIndex - 1);
                if (!Types.TryGetValue(typeId, out Type structType) || !StructMarshaling.IsStructType(structType))
                {
        ...
        private static int EnumInstanceToString(IntPtr luaState)
        {
            try
            {
                ...
                if (!StructMarshaling.TryGetBoxedTarget(luaState, 1, out object enumValue) || enumValue == null)
                {
        ...
        private static void PushInstanceMetatable(IntPtr luaState, Type type, int typeTableIndex)
        {
            ...
            if (type.IsArray && type.GetArrayRank() == 1)
            {
                ...
                IntPtr lenFn = global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(ArrayInstanceLenCallback);
            ...
            if (typeof(Delegate).IsAssignableFrom(type))
            {
                ...
                IntPtr callFn = global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(DelegateInstanceCallCallback);
        ...
        private static void RegisterArrayElementAccessMethods(IntPtr luaState, int methodTableIndex)
        {
            ...
            IntPtr getFn = global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(ArrayElementGetCallback);
            ...
            IntPtr setFn = global::System.Runtime.InteropServices.Marshal.GetFunctionPointerForDelegate(ArrayElementSetCallback);
        ...
        private static int ArrayInstanceLen(IntPtr luaState)
        {
            try
            {
                if (!StructMarshaling.TryGetBoxedTarget(luaState, 1, out object target) || !(target is Array array))
                {
        ...
        private static int DelegateInstanceCall(IntPtr luaState)
        {
            try
            {
                ...
                {
                    args[i] = MethodBridgeCore.ReadArgumentValue(luaState, i + 2, parameters[i].ParameterType);
                }

                object ret = del.DynamicInvoke(args);
                return MethodBridgeCore.PushReturnValue(luaState, invokeMethod.ReturnType, ret);
            }
            catch (Exception ex)
            {
        ...
        internal static LuaDataType RawGetField(IntPtr luaState, int tableIndex, string key)
        {
        ...
        internal static void RawSetField(IntPtr luaState, int tableIndex, string key)
        {
            int absIndex = LuaDll.lua_absindex(luaState, tableIndex);
            LuaDll.lua_pushstring(luaState, key);
        ...
        private static int ZLuaGetMethod(IntPtr luaState)
        {
            try
            {
                ...
                if (!MethodBridgeCore.TryFindMethodByParameterSignature(
                        targetType,
                        methodName,
                        signature,
                        isStatic,
                ...
                MethodBridgeCore.PushRegisteredMethodClosure(luaState, method, isStatic);
                return 1;
            }
            catch (Exception ex)
            {
        ...
        {
            return StructMarshaling.ReleaseBoxedInstance(luaState);
        }

        internal static Assembly ResolveAssembly(string luaAssemblyName)
        {
        ...
        internal static int GetOrCreateAssemblyId(Assembly assembly)
        {
        ...
        private static object ReadValue(IntPtr luaState, int luaIndex, Type type)
        {
            if (type.IsEnum)
            {
                if (StructMarshaling.TryReadEnumValue(luaState, luaIndex, type, out object enumValue))
                {
                    return enumValue;
                }
            ...
            if (StructMarshaling.IsStructType(type))
            {
                if (StructMarshaling.TryGetBoxedTarget(luaState, luaIndex, out object structValue)
                    && structValue != null
        ...
        {
            return MethodBridgeCore.PushReturnValue(luaState, returnType, ret);
        }
