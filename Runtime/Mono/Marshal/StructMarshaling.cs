...
{
    /// <summary>
    /// Mono �?struct / enum 实例 userdata：GCHandle 持有 box 后的对象，与 class 规则一致�?    /// </summary>
    internal static class StructMarshaling
    {
        ...
        internal static int PushBoxedInstance(IntPtr luaState, object instance, int typeTableIndex)
        {
            ...
            global::System.Runtime.InteropServices.Marshal.WriteIntPtr(userData, handlePtr);
            ...
            if (LuaDll.lua_type(luaState, -1) != LuaDataType.Table)
            {
                ...
                handle.Free();
                global::System.Runtime.InteropServices.Marshal.WriteIntPtr(userData, IntPtr.Zero);
        ...
        internal static bool TryGetBoxedTarget(IntPtr luaState, int index, out object target)
        {
            ...
            IntPtr handlePtr = global::System.Runtime.InteropServices.Marshal.ReadIntPtr(userData);
