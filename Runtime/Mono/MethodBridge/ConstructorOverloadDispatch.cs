...
namespace ZLua.MethodBridge
{
    ...
    /// </summary>
    internal static class ConstructorOverloadDispatch
    {
        ...
        private static readonly MethodInfo ThrowNoOverloadMethod = typeof(ConstructorOverloadDispatch).GetMethod(
        ...
        private static readonly MethodInfo InvokeCompiledInvokerMethod = typeof(ConstructorOverloadDispatch).GetMethod(
            ...
            out LuaCSFunction dispatch)
        {
            ...
            for (int i = 0; i < group.ConstructorIds.Length; i++)
            {
                ...
                if (ctor == null
                    || invoker == null
                    || !ConstructorBridge.CanFastInvoke(ctor))
                {
                    return false;
                }
