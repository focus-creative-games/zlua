...
namespace ZLua.MethodBridge
{
    ...
    /// </summary>
    internal static class EventBridgeFactory
    {
        ...
        internal static bool TryCreateFire(EventInfo eventInfo, MethodInfo raiseMethod, bool isStatic, out LuaCSFunction invoker)
        {
            ...
            return MethodBridgeFactory.TryCreate(raiseMethod, isStatic, out invoker);
        }
        ...
        private static bool TryCreateAccessor(MethodInfo accessor, bool isStatic, out LuaCSFunction invoker)
        {
            ...
            return MethodBridgeFactory.TryCreate(accessor, isStatic, out invoker);
        }
        ...
        internal static bool CanFastEvent(EventInfo eventInfo, bool isStatic)
        {
            ...
            return MethodBridgeFactory.CanFastInvoke(addMethod, isStatic)
                && MethodBridgeFactory.CanFastInvoke(removeMethod, isStatic);
        }
