...
namespace ZLua.MethodBridge
{
    ...
    internal static partial class LuaInvokeBridge
    {
        ...
        internal static byte[] Invoke_ByteArray_ByteArray(int funcRef, byte[] p0)
        {
            using CallScope scope = CallScope.Begin(funcRef);
            scope.PushFunction();
        ...
        internal static byte[] Invoke_ByteArray(int funcRef)
        {
            using CallScope scope = CallScope.Begin(funcRef);
            scope.PushFunction();
            scope.PCall(0, 1);
        ...
        internal static object Invoke_Object_Object(int funcRef, object p0)
        {
            using CallScope scope = CallScope.Begin(funcRef);
            scope.PushFunction();
