...
namespace ZLua.MethodBridge
{
    ...
    /// </summary>
    internal static class OverloadDispatch
    {
        ...
        private static readonly MethodInfo TryCanConvertArgumentsMethod = typeof(MethodBridgeCore).GetMethod(
            nameof(MethodBridgeCore.TryCanConvertArguments),
        ...
        private static readonly MethodInfo ThrowNoOverloadMethod = typeof(OverloadDispatch).GetMethod(
        ...
        private static readonly MethodInfo InvokeCompiledInvokerMethod = typeof(OverloadDispatch).GetMethod(
        ...
        private static readonly MethodInfo ValidateExactArgCountMethod = typeof(MethodBridgeMarshaling).GetMethod(
            nameof(MethodBridgeMarshaling.ValidateExactArgCount),
                        BindingFlags.NonPublic | BindingFlags.Static,
            binder: null,
        ...
        internal static bool TryCreate(
            MethodBridgeCore.DispatchGroup group,
            int dispatchId,
            ...
            out LuaCSFunction dispatch)
        {
            ...
            for (int i = 0; i < group.MethodIds.Length; i++)
            {
                ...
                if (method == null
                    || !MethodBridgeFactory.CanFastInvoke(method, group.IsStatic))
                {
                    return false;
                }
        ...
        private static LuaCSFunction Compile(MethodBridgeCore.DispatchGroup group, List<OverloadEntry> entries)
        {
            ...
            int argStartIndex)
        {
            ...
            {
                callArguments[i] = BridgeExpressionBuilder.BuildPopArgument(
                    luaStateParam,
                    argStartIndex + i,
            ...
            Expression setReturnCount = method.ReturnType == typeof(void)
                ...
                : BridgeExpressionBuilder.BuildPushReturn(
                    luaStateParam,
                    method.ReturnType,
                    callExpression);
        ...
        private static int ThrowNoOverload(IntPtr luaState, MethodBridgeCore.DispatchGroup group, int argStartIndex)
        {
            return MethodBridgeCore.FailNoOverloadForDispatch(luaState, group, argStartIndex);
        }
